export const serverVariableNames = ["FACTORY_PROVIDER", "CURSOR_API_KEY", "OPENAI_API_KEY", "OPENAI_BASE_URL", "OPENAI_MODEL", "CODEX_API_KEY", "CODEX_BASE_URL", "CODEX_PATH", "XAI_API_KEY", "XAI_MANAGEMENT_KEY", "GROK_PATH", "ANTHROPIC_API_KEY", "CLAUDE_PATH", "GITHUB_CLIENT_ID"] as const;
