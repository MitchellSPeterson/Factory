...
export const api = {
  ...
  servers: {
    ...
    reportProviderModels: ref<object, null>("servers.reportProviderModels"),
    setProviderEnabled: ref<{ provider: string; enabled: boolean; accessKey?: string }, null>("servers.setProviderEnabled"),
